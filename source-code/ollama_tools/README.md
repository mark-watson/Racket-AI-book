...
**Book Chapter:** [Ollama Tools/Function Calling in Racket](https://leanpub.com/racket-ai/read) — *Practical Artificial Intelligence Development With Racket* (free to read online).
