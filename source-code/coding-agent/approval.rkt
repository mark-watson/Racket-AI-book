...
;; ---------------------------------------------------------------------------
;; Interrupt flag -- delegated to fireworks-ai.rkt via dynamic-require
;; to avoid a circular require at load time.
...
(define (task-interrupted-set!)
  (with-handlers ([exn:fail? void])
    ((dynamic-require "fireworks-ai.rkt" 'task-interrupted-set!))))
